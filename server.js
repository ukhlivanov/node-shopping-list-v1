...
Recipes.create('Coffee Latte', ['milk','cofee','sugar']);
Recipes.create('Milk Cocktail', ['milk','fruits','syrop','ice']);
Recipes.create('Chocolate Milk', ['cocoa', 'milk', 'sugar']);
Recipes.create('Milk Shake', ['2 tbsp cocoa', '2 cups vanilla ice cream', '1 cup milk']);
